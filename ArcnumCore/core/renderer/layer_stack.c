...
__AC_CORE_API__ layer_stack* layer_stack_new()
{
...
__AC_CORE_API__ void layer_stack_push_overlay(layer_stack layer_stack, layer* layer)
{
	vector_push(layer_stack.layers, layer);
...
__AC_CORE_API__ void layer_stack_pop_layer(layer_stack layer_stack)
{
...
__AC_CORE_API__ void layer_stack_pop_overlay(layer_stack layer_stack)
{
	vector_pop(layer_stack.layers);
