...
__A_CORE_API__  mesh_component	   mesh_component_new(float64_vec values)
{
...
__A_CORE_API__  shader_component	   shader_component_new(GLuint vertex_shader, GLuint fragment_shader)
{
